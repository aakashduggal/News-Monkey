    ...
    render(){
        ...
        return(
            ...
            {!this.state.loading && this.state.articles.map((element)=>{
             ...
             <NewsItem title={element.title} dispcription={element.description} imageUrl={element.urlToImage} url={element.url} author={element.author} publishedAt={element.publishedAt} source={element.source.name}/>     
            </div>
            })}
